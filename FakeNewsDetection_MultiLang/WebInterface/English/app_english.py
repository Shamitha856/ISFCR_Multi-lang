...
def predict():
    ...
    try:
        ...
        if language == "hi" or language == "kn":
            ...
            print(pred1)
            return render_template('index_english.html', prediction1 = pred1)
        else:
...
def predict_text():
    if request.method == 'POST':
        ...
        if message.startswith("https://" or "http://" or "www."):
            pred2=['Url']
            return render_template('index_english.html', prediction2=pred2)
        ...
        return render_template('index_english.html', prediction2="Something went wrong")
    ...
    if request.method == 'POST' or 'GET':
        try:
            if 'photo' not in request.files:
                pred3=["No photo"]
                return render_template('index_english.html', prediction3 = pred3)
        ...
        return render_template('index_english.html',prediction3="Something went wrong")
