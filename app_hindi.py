...
loaded_model = pickle.load(open('model_hindi_pac.pkl', 'rb'))
dataframe = pd.read_csv('final_df_hindi.csv')
x = dataframe['long_description']
...
def predict_text():
    if request.method == 'POST':
        ...
        if message.startswith("https://" or "http://" or "www."):
            print('URL')
            pred2=['Url']
            return render_template('index_hindi.html', prediction2=pred2)
